...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="/validasiProgress/validasiKHS/{{ $angkatan }}">List Angkatan {{ $angkatan }}</a></li>
    <li class="breadcrumb-item active" aria-current="page">Detail KHS {{ $mahasiswa->nim }}</li>
  </ol>
</nav>
...
@include('operator.validasi_progress_studi.khs.modal_edit_khs')
