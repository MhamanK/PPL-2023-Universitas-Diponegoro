...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active text-white" aria-current="page">Validasi KHS</li>
  </ol>
</nav>
...
<div class="text-white">
  ...
  <a href="/validasiProgress/validasiKHS/{{ $angkatan }}" class="text-decoration-none" style="color:inherit;">
