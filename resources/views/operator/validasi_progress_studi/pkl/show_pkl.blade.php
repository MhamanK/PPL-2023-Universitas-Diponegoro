...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="/validasiProgress/validasiPKL/{{ $angkatan }}">List Angkatan {{ $angkatan }}</a></li>
    <li class="breadcrumb-item active" aria-current="page">Detail PKL {{ $mahasiswa->nim }}</li>
  </ol>
</nav>
...
@include('operator.validasi_progress_studi.pkl.modal_edit_pkl')
