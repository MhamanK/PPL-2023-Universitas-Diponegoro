...
<div class="card bg-body-tertiary mb-3">
  <div class="row">
    ...
    <div class="col m-4">
      ...
      <table class="table">
        <tr>
          <td class="bg-transparent">NIP</td>
          <td class="bg-transparent">: {{ auth()->user()->dosen_wali->nip }}</td>
        </tr>
        <tr>
          <td class="bg-transparent">No Telp</td>
          <td class="bg-transparent">: {{ auth()->user()->dosen_wali->no_telp }}</td>
        </tr>
        <tr>
          <td class="bg-transparent">Email SSO</td>
          <td class="bg-transparent">: {{ auth()->user()->dosen_wali->email_sso }}</td>
        </tr>
      </table>
